...
Seq[Any](_display_(/*1.2*/main("Contact")/*1.17*/ {_display_(Seq[Any](format.raw/*1.19*/("""
    """),format.raw/*2.5*/("""<h4>Welcome to the Contact Us Page</h4>
""")))}))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Fri Nov 17 16:16:14 GMT 2017
                  SOURCE: /media/sf_student/play-java-seed/app/views/contact.scala.html
                  HASH: 6cd9c73f7ab7ee90b2805782e6ec4cc624b88a66
