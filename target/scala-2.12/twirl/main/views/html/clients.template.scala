...
Seq[Any](_display_(/*1.2*/main("Clients")/*1.17*/ {_display_(Seq[Any](format.raw/*1.19*/("""
    """),format.raw/*2.5*/("""<h4>Welcome to the Clients Page</h4>
""")))}))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /media/sf_student/play-java-seed/app/views/clients.scala.html
                  HASH: 0c19dd187e0da07cc71ff892232c1442d9dba79a
