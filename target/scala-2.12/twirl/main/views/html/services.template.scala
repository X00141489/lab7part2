...
Seq[Any](_display_(/*1.2*/main("Services")/*1.18*/ {_display_(Seq[Any](format.raw/*1.20*/("""
    """),format.raw/*2.5*/("""<h4>Welcome to the Services Page</h4>
""")))}))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Fri Nov 17 16:16:15 GMT 2017
                  SOURCE: /media/sf_student/play-java-seed/app/views/services.scala.html
                  HASH: 73b7b8993de09318add2d5324813ef3d505f6b32
                  MATRIX: 1033->1|1057->17|1096->19|1127->24
